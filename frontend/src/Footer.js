  ...
  return <>
    ...
    <div className="container-fluid">
      ...
      >
        ...
        <section class="">
          <div className="row">
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
              ...
              />
              <p>
                Hello Everyone, Welcome you to  Grocery Store if u are planning to have  yummy and delicious treat to your tummy... then definitely  You are landing at right place.
              </p>
            </div>
            ...
            <div class="col-md-4 col-lg-3   col-xl-3 mx-auto mt-3">
              ...
              <div className="footer-media">
                <a class="btn btn-outline-white btn-floating m-1" class="text-white" role="button"><i class="fab fa-facebook-f"></i></a>
                <a
        ...
        >
          © 2021 Copyright:grocerystore.com
        </div>
      </footer>
    </div>
  </>
